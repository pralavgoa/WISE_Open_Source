...
public class dev2prod extends HttpServlet implements SingleThreadModel
{
       ...
       throws ServletException, IOException
	{
        ...
        if (admin_info==null || internal_id==null)   // if session does not exists
        {
        ...
        try
        {
            ...
            String sql = "SELECT id, filename, title FROM surveys WHERE internal_id = "+internal_id;
            ...
            sql += "VALUES ('"+s_id+"','"+filename+"',\""+title+"\", 'P')";
        ...
        {
            AdminInfo.log_error("Wise Admin - Dev to Prod Error: "+e.toString(), e);
            return;
        }
