	...
	public void service(HttpServletRequest req, HttpServletResponse res)
		...
		if(pf!=null)
		{
			...
			thankyou_html.append("<HTML><HEAD><TITLE>" + title
					+ " - Thanks</TITLE>");
			thankyou_html.append("<META http-equiv=Content-Type content='text/html; charset=iso-8859-1'>");
			thankyou_html.append("<LINK href='" + "styleRender?app="
					+ study_space.study_name + "&css=style.css"
					+ "' type=text/css rel=stylesheet>");
			thankyou_html.append("<META content='MSHTML 6.00.2800.1170' name=GENERATOR></HEAD>");
			// compose the top part of the body
			thankyou_html.append("<body><center>");
			thankyou_html.append("<table width=100% cellspacing=1 cellpadding=9 border=0>");
			thankyou_html.append("<tr><td width=98 align=center valign=top><img src='"
					+ "imageRender?app="
					+ study_space.study_name
					+ "&img="
					+ logo + "' border=0 align=middle></td>");
			thankyou_html.append("<td width=695 align=center valign=middle><img src='"
					+ "imageRender?app="
					+ study_space.study_name
					+ "&img="
					+ banner + "' border=0 align=middle></td>");
			thankyou_html.append("<td rowspan=6 align=center width=280>&nbsp;</td></tr>");
