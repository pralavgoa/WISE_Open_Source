...
//        tstout.close();
        ...
        if(initErr != null)
        {
            ...
            Surveyor_Application.log_error("WISE Surveyor Init Error: "+initErr, null);//should write to file if no email
            return;
        }
        ...
        {
	        myStudySpace = Study_Space.get_Space(spaceid_encode); //instantiates the study
	        if (myStudySpace !=null) {
		        id2=myStudySpace.id;
		        thesharedFile = myStudySpace.sharedFile_urlRoot;
		        Message_Sequence[] msa = myStudySpace.preface.get_message_sequences("Enrollmt");
            ...
            out.println("<HTML><HEAD><TITLE>Begin Page</TITLE>"
            		+ "<LINK href='../file_product/style.css' type=text/css rel=stylesheet>"
            		+ "<body text=#000000 bgColor=#ffffcc><center><table>"
            		+ "<tr><td>Successful test. StudySpace id [t]= " + spaceid_encode + "</td></tr>"
            		+ "<tr><td>Root URL= " + Surveyor_Application.rootURL + "</td></tr>"
            		+ "<tr><td>XML path = " + Surveyor_Application.xml_loc + "</td></tr>"
            		+ "<tr><td>SS file path = " + thesharedFile + "</td></tr>"
//            		+ "<tr><td>Image path = " + Surveyor_Application.image_root_path + "</td></tr>"
//            		+ "<tr><td>DB backup path = " + Surveyor_Application.db_backup_path + "</td></tr>"
