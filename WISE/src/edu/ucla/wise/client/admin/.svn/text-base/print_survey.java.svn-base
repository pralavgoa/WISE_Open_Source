...
public class print_survey extends HttpServlet
{
       ...
       throws ServletException, IOException
	{
        ...
        if(initErr != null)
        {
            out.println( initErr +"<p> Servlet called: Print Survey</p>" + Surveyor_Application.initErrorHtmlFoot);
        ...
        else
        {
            ...
            out.println("<link rel='stylesheet' href='"+ study_space.style_url +"print.css' type='text/css'>");
            out.println("</head>");
