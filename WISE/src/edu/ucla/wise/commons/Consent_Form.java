...
public class Consent_Form {
    ...
    public String consent_header_html = "", consent_p = "", consent_ul = "",
	    consent_s = "";
	...
	try {
	    ...
	    survey_id = n.getAttributes().getNamedItem("Survey_ID")
		    .getNodeValue();
		...
		if (node_p.item(j).getNodeName()
			...
			if (node_n.item(k).getNodeName()
			    ...
			    consent_header_html += node_n.item(k)
				    .getNodeValue();
		    }
		}
	    ...
	    WISE_Application.log_error("WISE - CONSENT FORM : ID = " + id
