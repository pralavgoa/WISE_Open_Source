...
/**
This class is a subclass of Question and represents an open ended question on the page
*/
...
/** count number of field for an open ended question - each has only one field */
    public int countFields()
    {
        return 1;
    }
    // just render html; unlike closed- and question blocks, no shared-element references to knit
...
/*
    ...
    {
        return super.render_results(data, whereclause);
    }
*/
...
/** print survey for an open ended question - used for admin tool: print survey */
/*
    public String print_survey()
    {
        String s = super.render_form();
        s += this.common_render_form();    
        return s;
    }
*/
}
