...
private String process_survey_file(Document doc, JspWriter out, Statement stmt) throws SQLException
{
    ...
    try
    {
		...
		{
        AdminInfo.log_error("WISE ADMIN - PROCESS SURVEY FILE:"+e.toString(), e);
        return_val="ERROR";
		}
    return return_val;
}
...
<%                    
    ...
    {
            AdminInfo.log_error("WISE - ADMIN LOAD: "+e.toString(), e);
...
<pre>
		...
		alert email: <%=admin_info.alert_email %>
            <%=admin_info.email_from %>
            <%=admin_info.mail_username%>
            <%=admin_info.mail_password %>
	   </pre>
</p>
</body>
</html>
