...
public class survey_update extends HttpServlet 
{
       ...
       throws ServletException, IOException
	{
        ...
        out.println("<p>WISE Surveyor Application "+ Surveyor_Application.ApplicationName +" on "+ 
        		WISE_Application.rootURL +": ");
        if(initErr != null)
        {
            out.println( "<p> FAILED to initialize </p>" );
            WISE_Application.log_error("WISE Surveyor Init Error from survey_update servlet: "+initErr, null);//should write to file if no email
            return;
        }
        ...
        try
        {
        	if(survey_status.equalsIgnoreCase("R")|| survey_status.equalsIgnoreCase("P") )
        	{
        ...
        {
            WISE_Application.log_error("WISE - DROP SURVEY DATA: "+e.toString(), null);
