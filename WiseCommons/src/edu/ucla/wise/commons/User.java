...
public class User {
	...
	public User(String myID, Survey survey, String msg_id, DataBank db) {
	...
	public void set_interrupt() {
		...
		MessageSequence msgSeq = get_current_MessageSequence();
	...
	public MessageSequence get_current_MessageSequence() {
		Preface preface;
