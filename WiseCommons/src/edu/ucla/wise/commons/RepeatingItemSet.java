...
public class RepeatingItemSet extends PageItem {
    ...
    public String title;
    public ArrayList<PageItem> item_set = new ArrayList<PageItem>();
     ...
     */
    public RepeatingItemSet(Node i_node) {
	...
	try {
		...
		if (PageItem.IsPageItemNode(child_node)) {
		    PageItem current_item = PageItem.MakeNewItem(child_node);
	...
	for (PageItem repeating_item : item_set) {
	...
	String nname = null;
	RepeatingItemSet repeating_item = null;
	try {
	    nname = n.getNodeName();
